...
class Qiege_Smooth(bpy.types.Operator):
    bl_idname = "qiege.smooth"
    bl_label = "Qiege: Smooth"
...
def register():
    bpy.utils.register_class(Qiege_Smooth)


def unregister():
    bpy.utils.unregister_class(Qiege_Smooth)
