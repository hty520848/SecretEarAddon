...
class TOPBAR_HT_upper_bar(bpy.types.Header):
    ...
    def draw_left(self, context):
        ...
        TOPBAR_MT_editor_menus.draw_collapsible(context, layout)              #File Edit  惠尔文件菜单
...
class VIEW3D_HT_header(bpy.types.Header):
    ...
    def draw(self,context):
        ...
        layout.operator("wm.open_mainfile", text="", icon_value=icon.icon_id)
        icon = icons.get("icon_transparency1")   
        layout.popover("TOPBAR_MT_transparency1", text="", icon_value=icon.icon_id)
        icon = icons.get("icon_transparency2")   
        layout.popover("TOPBAR_MT_transparency2", text="", icon_value=icon.icon_id)
        icon = icons.get("icon_transparency3")   
        layout.popover("TOPBAR_MT_transparency3", text="", icon_value=icon.icon_id)
