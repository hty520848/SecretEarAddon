...
class CustomPaneldamo(bpy.types.Panel):
    ...
    def draw_header(self, context):
        ...
        if not op_cls.is_running():
            layout.operator(op_cls.bl_idname, text="开始本流程", icon='PLAY')
        else:
            layout.operator(op_cls.bl_idname, text="结束本流程", icon='PAUSE')
...
class TOPBAR_MT_transparency1(bpy.types.Menu):
    bl_label = "透明度1"
...
class TOPBAR_MT_transparency2(bpy.types.Menu):
    bl_label = "透明度2"
...
class TOPBAR_MT_transparency3(bpy.types.Menu):
    bl_label = "透明度3"
...
class VIEW3D_HT_header(bpy.types.Header):
    ...
    def draw(self, context):
        ...
        row.operator("wm.open_mainfile", text="", icon_value=icon.icon_id)
        row.separator()
        icon = icons.get("icon_backup")
        row.operator("ed.undo", text="", icon_value=icon.icon_id)
        row.separator()
        icon = icons.get("icon_forward")
        row.operator("ed.redo", text="", icon_value=icon.icon_id)
        row.separator()
        ...
        row.menu("TOPBAR_MT_transparency1", text="", icon_value=icon.icon_id)
        icon = icons.get("icon_transparency2")
        row.menu("TOPBAR_MT_transparency2", text="", icon_value=icon.icon_id)
        icon = icons.get("icon_transparency3")
        row.menu("TOPBAR_MT_transparency3", text="", icon_value=icon.icon_id)
...
class CustomPanelTestButton(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col.operator("obj.reducearea", text="缩小域")
        col.operator("obj.jiahou", text="加厚")
