...
def saveInfo():
    ...
    if (plane_obj != None):
        ...
        prev_location_y = plane_obj.location[0]
        prev_location_z = plane_obj.location[0]
...
def addHandle():
    ...
    bpy.ops.mesh.primitive_cube_add(
        enter_editmode=False, align='WORLD', location=(-20, 6, 1), scale=(1, 1, 1))
    bpy.ops.mesh.primitive_plane_add(
        enter_editmode=False, align='WORLD', location=(-20, 6, 0), scale=(1, 1, 1))
...
def register():
    ...
    # bpy.utils.register_tool(MyTool_Handle2, separator=True, group=False, after={
    #                         MyTool_Handle1.bl_idname})
    # bpy.utils.register_tool(MyTool_Handle3, separator=True, group=False, after={
    #                         MyTool_Handle2.bl_idname})
